...
| **Problem Statement** | Giúp nhóm chốt lại success metric thực tế (thời gian debug giảm xuống < 5 phút và pass bài trong ≤ 3 lượt chat). | PS trở nên đo lường được thay vì nói chung chung "giúp SV học tốt hơn". |
...
Tôi sẽ challenge nhóm nghĩ sâu hơn về cách đánh giá thế nào là "hiểu bài". Hiện tại metric "số lượt chat (conversational turns) ≤ 3" vẫn có thể bị đánh lừa nếu sinh viên âm thầm mở tab khác lấy code rồi quay lại chat cho đủ vòng. Có lẽ cần bổ sung metric đo lường chất lượng câu trả lời của sinh viên trong từng lượt (đúng hướng suy nghĩ hay chỉ gõ đại), không chỉ đếm số lượt.
